...
本章では、UIのPoCを設計上の検討資料として定義する。\
PoCは実装確定仕様ではなく、操作性および画面構成の妥当性を確認するための成果物として扱う。\
本PoCはUI方針確認用であり、最終実装時にレイアウト・文言・配色等が変更される場合がある。
...
[Figma VoiceNote URL](https://www.figma.com/design/xEb3wp0lGLDFB3aWCpBa4s/VoiceNote?node-id=0-1&t=AzRz1pzsn0qeU9sF-1)
